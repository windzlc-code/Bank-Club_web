  ...
  return (
    <PublicShell>
      <main className="legal-page">
        ...
        <section>
          <h2>蒐集資料類別</h2>
          <p>第一階段表單僅蒐集姓名、手機、LINE ID、身份類型、貸款類型、期望金額、預約時段、資金用途、備註、房屋或企業初步資料、來源參數、同意時間、IP 與 user agent。</p>
          <p>本網站不要求使用者上傳身分證照片、財力證明、銀行存摺影本或稅務文件。若後續需補件，應先與專員確認授權通道與必要性。</p>
        </section>
        <section>
          <h2>利用期間、地區、對象與方式</h2>
